...
const ConfirmOderContext = React.createContext();
...
function ConfirmOrder(props) {
  ...
  return (
    <ConfirmOderContext.Provider value={{ orderSuccess, setOrderSuccess }}>
    ...
    </ConfirmOderContext.Provider>
  );
}

const useConfirmOrder = () => React.useContext(ConfirmOderContext);

export { ConfirmOrder, useConfirmOrder };
